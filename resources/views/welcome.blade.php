...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center mb-1 sm:block">Welcome to Our Application</h2>
        <div class="row justify-content-center">
            
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Admin Panel</a>
                    @else
